...
sc_ref_path = 'For_sim_sc.h5ad'
sp_ref_path = 'For_sim_sp.h5ad'

num_celltype = 13
sc_size_per_spot = 2
simdata = picasa.sim.generate_simdata(sc_ref_path,sp_ref_path,num_celltype,sc_size_per_spot,rho=1.0)
...
sns.scatterplot(x='x',y='y',hue='celltype',data=simdata['sp_pos'],s=70)
...
adata_sc.obs['celltype'] = [''.join(x.split('_')[2:]) for x in adata_sc.obs.index.values]
...
adata_sp.write('sim_sp.h5ad',compression='gzip')
adata_sc.write('sim_sc.h5ad',compression='gzip')
