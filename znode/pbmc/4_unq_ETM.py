...
picasa_object.train_unique_etm(input_dim, enc_layers,common_latent_dim,unique_latent_dim,dec_layers,l_rate=0.001,epochs=1000,batch_size=128,device='cuda')
...
df_u, df_beta = picasa_object.eval_unique_etm(input_dim, enc_layers,common_latent_dim,unique_latent_dim,dec_layers,eval_batch_size, eval_total_size,device='cuda')
...
sns.clustermap(df_beta.T,cmap='viridis',col_cluster=False)
plt.savefig(wdir+'results/etm_beta.png')
plt.close()