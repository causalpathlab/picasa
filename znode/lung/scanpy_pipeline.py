...
plt.savefig(wdir+'scanpy_results/scanpy_umap.png')
...
plt.savefig(wdir+'scanpy_results/scanpy_umap_bbknn.png')
...
plt.savefig(wdir+'scanpy_results/scanpy_umap_combat.png')
...
plt.savefig(wdir+'scanpy_results/scanpy_umap_mnn.png')
...
plt.savefig(wdir + 'scanpy_results/scanpy_umap_harmony.png')
...
plt.savefig(wdir + 'scanpy_results/scanpy_umap_scanorama.png')
...
# plt.savefig(wdir + 'scanpy_results/scanpy_umap_scvi.png')
