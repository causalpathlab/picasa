...
adata = an.read_h5ad('main_haber_2017.h5ad')
...
cid = [x+'_'+y for x,y in zip(adata.obs.cell_group,adata.obs.barcode)]
...
for batch in batch_keys:
    ...
    adata_b.write('haber_'+str(batch)+'.h5ad',compression='gzip')

dfl = adata.obs.reset_index()
dfl.to_csv('haber_label.csv.gz',compression='gzip')
