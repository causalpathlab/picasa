...
def plot_scsp_overlay():
	...
	df_umap['celltype'] = [x.split('_')[1] for x in df_umap['cell'].values]
	df_umap['batch'] = [x.split('_')[0] for x in df_umap['cell'].values]
	plot_umap_df(df_umap,'batch',wdir+'results/nn_attncl_scsp_',pt_size=0.1,ftype='png') 
	plot_umap_df(df_umap,'celltype',wdir+'results/nn_attncl_scsp_',pt_size=0.1,ftype='png') 
	...
	df_umap['celltype2'] = [ 'sp_'+spmap[x.replace('sp_','')] if 'sp_' in x else 'sc_'+x.split('_')[1] for x in df_umap['cell'] ]
	plot_umap_df(df_umap,'celltype2',wdir+'results/nn_attncl_scsp_',pt_size=0.1,ftype='png') 
