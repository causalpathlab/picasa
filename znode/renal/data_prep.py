...
import h5py as hf
f = hf.File('KIRC_GSE159115_expression.h5')
...
dfl = pd.read_csv('KIRC_GSE159115_CellMetainfo_table.tsv',sep='\t')

## how to select patients?NONE in this case
...
for batch in batch_keys:
    ...
    adata_b.write('renal_'+str(batch)+'.h5ad',compression='gzip')
