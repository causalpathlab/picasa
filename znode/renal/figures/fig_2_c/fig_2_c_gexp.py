...
plot_marker_genes(wdir+cdir,df_main.iloc[:,:-1],umap_coords,marker,nr=6,nc=6)


marker = ["IL7R", "CD79A", "MS4A1", "CD8A", "CD8B", "LYZ", "CD14",
    "LGALS3", "S100A8", "GNLY", "NKG7", "KLRB1",
    "FCGR3A", "MS4A7", "FCER1A", "CST3", "PPBP",'EPCAM','MKI67','CD3D','CD68','MS4A1','JCHAIN','PECAM1','PDGFRB']

plot_marker_genes(wdir+cdir+'_2_',df_main.iloc[:,:-1],umap_coords,marker,nr=5,nc=5)