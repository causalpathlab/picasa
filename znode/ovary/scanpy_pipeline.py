...
sc.pl.umap(adata, color=["leiden","sample","cell_type"])
...
sc.pl.umap(adata_bbknn, color=["leiden","sample","cell_type"])
...
sc.pl.umap(adata_combat, color=["leiden","sample","cell_type"])
...
sc.pl.umap(adata_mnn, color=["leiden", "sample","cell_type"])
