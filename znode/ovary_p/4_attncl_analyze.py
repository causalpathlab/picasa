...
def plot_scsp_overlay():
	...
	umap_2d = picasa.ut.analysis.run_umap(dfh.to_numpy(),use_snn=False,min_dist=0.8,n_neighbors=30)
	...
	df_umap['test'] = ['1TEST' if x in ['EOC136','EOC153'] else  '0TRAIN' for x in df_umap['batch_x']  ]
