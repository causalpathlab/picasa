...
params = {'device' : 'cuda',
		...
		'projection_layers' : [15,25],
		'learning_rate' : 0.001,
		'lambda_loss' : [0.1,0.01,2.0],
		'temperature_cl' : 1.0,
...
def plot_scsp_overlay():
	...
	umap_2d = umap.UMAP(n_components=2, init='random', random_state=0,min_dist=0.1,n_neighbors=20,metric='cosine').fit(dfh)
