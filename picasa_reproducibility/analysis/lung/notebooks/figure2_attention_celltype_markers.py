...
marker = {
    'Common0/Malignant': ['EPCAM', 'SFTPA1', 'KRT6A', 'KRT5', 'NAPSA', 'EGFR', 'SOX2', 'MYC', 'TP63', 'DSG3', 'MUC16', 'PAX8', 'CLDN3','NKX2','NKX1'],
    
    'Common1/Monocyte': ['CD14', 'CD68', 'LYZ', 'FCGR3A', 'FCGR1A', 'CD163', 'MRC1', 'FCN1','APOE','CD1C','CD207','S100A9','S100A8','S100A12','CXCL9','CXCL10','CXCL11','GBP5','MARCO','CXCL5','MCEMP1','MMP12','IL7R','MT1G'],
    
    'Common9/Fibroblasts': ['COL1A1', 'COL1A2', 'COL3A1', 'DCN', 'ACTA2', 'LUM', 'C1R', 'FAP','CCL2','CCL11','BMP4','MMP11','MMP12','MMP1','MMP9','IFIT1','ACGT2','MCAM','RGS5','MYH11'],
    
    'Common16/T': ['CD2', 'CD3D', 'CD3E', 'CD3G', 'CD8A', 'TRAC', 'NKG7', 'GNLY', 'GZMA', 'GZMK', 'GZMB', 'GZMH','KLRC1','KLRD1','CCR7','LEF1','IL7R','SELL','LAG3'],
    ...
    'Common19/Endothelial': ['VWF', 'PECAM1', 'CLDN5', 'FLT1', 'KDR', 'CDH5', 'ANGPT2', 'ACKR1', 'GJA5', 'PROX1', 'PDPN', 'ESM1','APLN','CXCL12','NR2F2','MMRN1','GJA4','EFNB2','IFIT1','IFIT3','ISG20'],
    
    'Common12/Plasma': ['CD38', 'SDC1', 'MZB1', 'XBP1', 'IGHG1', 'IGHG3', 'PRDM1','JCHAIN'],
    ...
    'Common18/Epithelial': ['EPCAM','CAPS','TFF3','SNTN','CDH1','CLDN18','AQP4','CAV1','AGER','SFTPC','SFTPA1','ABCA3','SCGB1A1','SCGB3A1','FOXJ1','TPPP3','PIFO'],
