...
plt.savefig('results/figure3_cancer_common_umap.png')
...
picasa_adata.obs.index = ['@'.join(x.split('@')[:2])for x in picasa_adata.obs.index.values]
...
adata.write('data/figure3_cancer_common_selected_cells.h5ad',compression='gzip')
