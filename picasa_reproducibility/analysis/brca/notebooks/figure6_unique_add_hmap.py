...
df_w_topic = pd.read_csv('data/figure6_unique_add_topic_gene.csv.gz',index_col=0)


selected_topics = df_w_topic['index'].unique()
...
sns.clustermap(df_w.T,
               yticklabels=True,
               xticklabels=True,
               cmap='viridis',figsize=(5,25))
plt.savefig( 'results/figure6_unique_add_hmap_selected.pdf')
