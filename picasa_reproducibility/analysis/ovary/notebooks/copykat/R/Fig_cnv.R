...
ggsave("cnv_cor_ovary.pdf", plot=plot.cnv.corr("ovary"), width=6, height=3.5)
# ggsave("cnv_cor_brca.pdf", plot=plot.cnv.corr("brca"), width=6, height=2.8)
# ggsave("cnv_cor_lung.pdf", plot=plot.cnv.corr("lung"), width=6, height=2.2)
