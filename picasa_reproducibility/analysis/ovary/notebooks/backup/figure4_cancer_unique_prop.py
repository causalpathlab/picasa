...
adata = ad.read_h5ad('data/figure4_cancer_unique_selected_cells.h5ad')
####################################
...
p.save(filename = 'results/figure4_cancer_unique_cluster_prop.pdf', height=10, width=15, units ='in', dpi=600)