...
def read_ext():
	...
	f = hf.File('data/OV_GSE158722_expression.h5')
	...
	dfl = pd.read_csv('data/OV_GSE158722_CellMetainfo_table.tsv',sep='\t')

	adata = adata[adata.obs['batch'].isin(['P04', 'P06', 'P07', 'P09', 'P13'])]
