...
def plot_lisi(df_res):
    ...
    df_summary["Method"] = pd.Categorical(df_summary["Method"], categories=['PCA','BBKNN','Combat','Harmony', 'Scanorama','Liger','scVI','PICASA_C','PICASA_U','PICASA_UC','PICASA_B'], ordered=True)
