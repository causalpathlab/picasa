...
sc.pl.umap(picasa_adata,color=[constants.BATCH,constants.GROUP])
plt.savefig(wdir+'/results/picasa_common_umap.png')

sc.pl.umap(picasa_adata,color=[constants.GROUP],legend_loc=None)
plt.savefig(wdir+'/results/scanpy_picasa_umap_celltype.png')

sc.pl.umap(picasa_adata,color=[constants.BATCH],legend_loc=None)
