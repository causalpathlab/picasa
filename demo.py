...
sample = 'pbmc'
cp = '/home/BCCRC.CA/ssubedi/projects/experiments/picasa/'
ddir = cp+'znode/pbmc'

batch1 = an.read_h5ad(ddir+'/data/'+sample+'_pbmc1.h5ad')
batch2 = an.read_h5ad(ddir+'/data/'+sample+'_pbmc2.h5ad')
...
picasa_object.train_unique(input_dim, enc_layers,common_latent_dim,unique_latent_dim,dec_layers,l_rate=0.001,epochs=2,batch_size=128,device='cuda')
