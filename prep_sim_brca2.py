...
sc_ref_path = 'brcasim_sc.h5ad'
sp_ref_path = 'brcasim_sp.h5ad'

dfsc,dfsp,nbrs = picasa.sim.generate_simdata(sc_ref_path,sp_ref_path,sc_size=25)
# dfsp.to_csv('dataspmap_brca.csv')
